...
from api.Social.schemas.post_comments import (
    CommentResponse, 
    CreateCommentSchema, 
    UpdateCommentSchema, 
    UserResponse, 
...
from api.Social.models.post_comment import PostComment
...
class CommentService:
    ...
    def __init__(self):
        ...
        self.post_not_found = HTTPException(
            status_code=status.HTTP_404_NOT_FOUND, detail="Post does not exist"
        )

        self.comment_not_found = HTTPException(
    ...
    def create(
        ...
        try:
            ...
            comment_owner = user_service.get_user_details(db=db, user_id=user.id)
    ...
    def get_comments(self, db: Session, user: User, post_id: str):
        ...
        try:
            ...
            for comment in comments:
                owner_details = user_service.get_user_details(db=db, user_id=comment.user_id)
